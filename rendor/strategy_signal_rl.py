...
ACTION_REASONS = {
    "increase ad spend": "Scales awareness quickly but can increase CAC and competitive pressure.",
    "change channel mix": "Rebalances acquisition toward healthier channels and improves marketing efficiency.",
    "delay launch": "Buys time to improve readiness when product or timing risk is too high.",
    "launch beta": "Tests the market with lower timing risk before a broader release.",
    "improve onboarding": "Lifts conversion before scaling more traffic into the funnel.",
    "reduce feature scope": "Cuts complexity to improve readiness and reduce launch risk.",
    "target niche segment": "Improves positioning by narrowing focus and lowering competitive pressure.",
}
...
def train_rl_policy(strategy_timeseries, checkpoint_path=None, episodes=320, alpha=0.20, gamma=0.92):
    ...
    ranked_actions = [
        {
            ...
            "reason": ACTION_REASONS.get(action_name, "Policy-ranked action."),
        }
    ...
    for state_name, values in q_table.items():
        ...
        policy[state_name] = ACTIONS[best_action_index]
