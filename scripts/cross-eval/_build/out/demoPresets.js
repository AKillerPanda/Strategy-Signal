...
exports.DEMO_PRESETS = void 0;
exports.getDemoPreset = getDemoPreset;
exports.evaluateDemoPreset = evaluateDemoPreset;
const SHARED_FEATURE_TOUR = [
    {
        title: 'Dashboard',
...
function getDemoPreset(id) {
    return exports.DEMO_PRESETS.find((preset) => preset.id === id);
}
function evaluateDemoPreset(presetId) {
    const preset = getDemoPreset(presetId) ?? exports.DEMO_PRESETS[0];
    return {
        input: preset.input,
        result: {
            ...preset.result,
